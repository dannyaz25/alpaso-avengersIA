...
function CapAssistant() {
  ...
  const speakResponse = (text: string) => {
    ...
    utterance.rate = 0.9; // Cap habla más pausado y reflexivo
    utterance.pitch = 0.8; // Voz más grave y autoritaria
      ...
      >
        <HeaderContent>
          ...
          <HeaderInfo>
            ...
            <Role>Leadership & Strategy Assistant</Role>
          ...
          <InputArea>
            <InputContainer>
              <Input
                ...
                placeholder={isListening ? "Hablando..." : "Escribe o habla para consultar con Cap..."}
